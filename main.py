...
#         # Flight ID Input
#         self.lbl_flight_id = tk.Label(self.frame, text="Flight ID:")
#         self.lbl_flight_id.grid(row=0, column=0, padx=5, pady=5)
#         self.entry_flight_id = tk.Entry(self.frame)
#         self.entry_flight_id.grid(row=0, column=1, padx=5, pady=5)

#         # Origin Input
#         self.lbl_origin = tk.Label(self.frame, text="Origin:")
#         self.lbl_origin.grid(row=1, column=0, padx=5, pady=5)
#         self.entry_origin = tk.Entry(self.frame)
#         self.entry_origin.grid(row=1, column=1, padx=5, pady=5)

#         # Destination Input
#         self.lbl_destination = tk.Label(self.frame, text="Destination:")
#         self.lbl_destination.grid(row=2, column=0, padx=5, pady=5)
#         self.entry_destination = tk.Entry(self.frame)
#         self.entry_destination.grid(row=2, column=1, padx=5, pady=5)

#         # Seats Input
#         self.lbl_seats = tk.Label(self.frame, text="Seats:")
#         self.lbl_seats.grid(row=3, column=0, padx=5, pady=5)
#         self.entry_seats = tk.Entry(self.frame)
#         self.entry_seats.grid(row=3, column=1, padx=5, pady=5)

#         # Add Flight Button
#         self.btn_add_flight = tk.Button(self.frame, text="Add Flight", command=self.add_flight)
#         self.btn_add_flight.grid(row=4, column=0, columnspan=2, pady=10)

#         # View Flights Button
#         self.btn_view_flights = tk.Button(self.frame, text="View All Flights", command=self.view_flights)
#         self.btn_view_flights.grid(row=5, column=0, columnspan=2, pady=10)

#         # User ID Input
#         self.lbl_user_id = tk.Label(self.frame, text="User ID:")
#         self.lbl_user_id.grid(row=6, column=0, padx=5, pady=5)
#         self.entry_user_id = tk.Entry(self.frame)
#         self.entry_user_id.grid(row=6, column=1, padx=5, pady=5)

#         # User Name Input
#         self.lbl_user_name = tk.Label(self.frame, text="User Name:")
#         self.lbl_user_name.grid(row=7, column=0, padx=5, pady=5)
#         self.entry_user_name = tk.Entry(self.frame)
#         self.entry_user_name.grid(row=7, column=1, padx=5, pady=5)

#         # Add User Button
#         self.btn_add_user = tk.Button(self.frame, text="Add User", command=self.add_user)
#         self.btn_add_user.grid(row=8, column=0, columnspan=2, pady=10)

#         # Book Flight Button
#         self.btn_book_flight = tk.Button(self.frame, text="Book Flight", command=self.book_flight)
#         self.btn_book_flight.grid(row=9, column=0, columnspan=2, pady=10)

#         # View User Bookings Button
#         self.btn_view_user_bookings = tk.Button(self.frame, text="View User Bookings", command=self.view_user_bookings)
#         self.btn_view_user_bookings.grid(row=10, column=0, columnspan=2, pady=10)
...
#             self.flight_manager.add_flight(flight_id, origin, destination, int(seats))
...
#             self.user_manager.add_user(user_id, user_name)
...
#             success = self.user_manager.book_flight(user_id, flight_id)
#             if success:
...
#         else:
#             messagebox.showerror("Error", "Please enter a valid User ID and Flight ID.")

#     def view_user_bookings(self):
#         user_id = self.entry_user_id.get()

#         if user_id:
#             bookings = self.user_manager.get_user_bookings(user_id)
